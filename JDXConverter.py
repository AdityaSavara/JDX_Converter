...
if (fileYorN =='no'):
    print("Welcome! Enter the name of the molecule, it's mass, it's number of electrons (or the number 0 if you don't need that) and the associated JDX file in order to generate a csv spectrum file")
